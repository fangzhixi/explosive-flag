...
//    char v8[29]; // [esp+3Bh] [ebp-1Dh] BYREF
//    int i = 0;
//
//    strcpy(v8, "Qsw3sj_lz4_Ujw@l");
//    printf("Please input:");
////    scanf("%s", input_str);
...
//                            i = 0;
//                            while (i <= 15) {
//                                if (*(input_str + v1 + i) > '@' && *(input_str + v1 + i) <= 'Z')// 大写
//                                    *(input_str + v1 + i) = (input_str[v1 + i] - 51) % 26 + 'A';
//                                if (*(input_str + v1 + i) > '`' && *(input_str + v1 + i) <= 'z')// 小写
//                                    *(input_str + v1 + i) = (input_str[v1 + i] - 79) % 26 + 'a';
//                                ++i;
//                            }
//                            i = 0;
//                            while (i <= 15) {
//                                if (*(input_str + v1 + i) != v8[i]) {
//                                    GenerateFlag(GENERATE_STATUS_IS_NOT_MATCH_CURRENT_VALUE,
//                                                 i);
//                                } else {
//                                    GenerateFlag(GENERATE_STATUS_IS_MATCH_CURRENT_VALUE,
//                                                 i);
//                                }
//                                ++i;
//                            }
